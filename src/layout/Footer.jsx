    ...
    <div className="wrapper bg-footer py-[20px] sm:py-[50px] mt-20">
      <div className="w-[90%] grid grid-cols-2 grid-rows-2 lg:flex max-w-[1600px] justify-between items-center lg:gap-0 gap-6 sm:gap-10 lg:items-end">
        <div className="flex justify-start sm:max-w-[300px] xl:max-w-[400px] items-center text-center lg:text-left lg:items-start flex-col gap-3">
          ...
          <p className="text-black xl:text-base text-xs font-medium">
            © 2023 On point - All Right Reserved{" "}
          </p>
        </div>
        <div className="lg:hidden flex justify-start items-center lg:items-start text-center lg:text-left flex-col gap-4 sm:gap-3">
          <a href="#" className="text-black text-sm sm:text-base font-normal">
            Home
          </a>
          <a href="#" className="text-black text-sm sm:text-base font-normal">
            Portfolios
        ...
        <div className="lg:hidden flex justify-start items-center lg:items-start text-center lg:text-left flex-col gap-4 sm:gap-3">
          <a
            href="#"
            className="text-black text-sm sm:text-base font-normal uppercase"
          >
            Membership
          </a>
          <a
        ...
        <div className="hidden lg:flex justify-start sm:flex-row flex-col items-center sm:items-start gap-4 sm:gap-20 xl:gap-[150px] pb-3">
